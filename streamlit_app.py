...
st_button('titok', 'https://tiktok.com/@alecstec', 'Canal no TIktok', icon_size)
st_button('instagram', 'https://instagram.com/alecstec', 'Conteudo Diario no Instagram', icon_size)
